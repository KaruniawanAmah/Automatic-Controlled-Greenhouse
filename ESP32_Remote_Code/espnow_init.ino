...
void sendData() {
  ...
  // Serial.print("Sending: "); Serial.println(datatosend);
...
void OnDataRecv(const uint8_t * mac, const uint8_t *incomingData, int len) {
  ...
  Serial.print("Temperature: "); Serial.println(receivedData.temp);
  Serial.print("Humidity: "); Serial.println(receivedData.humidity);
  Serial.print("Misting: "); Serial.println(receivedData.misting ? "ON" : "OFF");
}
